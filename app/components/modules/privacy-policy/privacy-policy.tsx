...
const PrivacyPolicy = () => {
  const privacyPolicyData = [
    ...
    },
    {
      ...
      content: `<p>
  <p>A. PERSONAL INFORMATION</p><br />
  We collect personal information that we receive directly from you, when you register for an account, create or modify your profile, participate in interactive features of the Platform, or otherwise communicate with us. The personal information that we collect also depends on the context of your interactions with us and the Services, the choices you make, and the products and features you use. The types of information we may collect include:
</p>
...
<br/>
<p>
  <p>B. DEVICE INFORMATION</p><br />
  We collect Device Information that is automatically processed when you visit our website or contact us directly by any communication channel, we may collect information, including personal information, about the services you use and how you use them.
</p><br/>

<p>
  This information is necessary for the adequate performance of the contract between you and us, to enable us to comply with legal obligations and to give our legitimate interest in being able to provide and improve the functionalities.
</p><br/>
...
<p>
  We process this information on the legal basis of your consent; conclusion and performance of contractual arrangements and obligations between Us and the User; pursuance of legitimate interests of us, as Data Controller and manager of our website.
</p>
...
If you are under 18 years of age, reside in California, and have a registered account with the Site, you have the right to request removal of unwanted data that you publicly post on the Site. To request removal of such data, please contact us using the contact information provided below, and include the email address associated with your account and a statement that you reside in California. We will make sure the data is not publicly displayed on the Site, but please be aware that the data may not be completely or comprehensively removed from our systems.`,
    },
    {
      ...
      content: `We don’t collect any personal information from any children. We will not collect, store or use any personal information in any way from any children who is below 18 years of age. The Incc complies with the Children’s Online Privacy Protection Act defined under the local territory of every user of our website. `,
    },
    {
...
We can also provide information upon request as to what personal data is stored about you. In addition, we will correct or erase personal data at your request, with the expectation of data retained for legal obligations. To learn more or to make any of the request described above, email us at (add URL).`,
    ...
    {
      title: "DATA SECURITY",
      content: `We take all reasonable and necessary steps to protect the information provided by you from unauthorized access. We follow commonly accepted industry standards to protect the personal information submitted to us. We are also using SSL CERTIFICATE security system for ensuring and protect the confidentiality of your personally identifiable information. However, no method of transmission over the Internet or method of electronic storages is 100% safe and secure. Therefore, we are not in the actual position to guarantee the absolute security of your information. If you have any questions about security on our website, you can submit us an email on (add URL).`,
    },
    {
      title: "DATA RETENTION OF PERSONAL INFORMATION",
      content: `When you fill out a personal information details through the Site, we may keep and maintain your personal Information on our systems for the period necessary to fulfil the purposes outlined in this Privacy Policy or and until you ask us to delete this information.`,
    },
    {
      title: "YOUR PERSONAL DATA RIGHTS AND CHOICES",
      content: `<p>
...
<p>
  This Privacy Policy shall be governed and construed in all respects in accordance with laws of the United States such as the California Consumer Privacy Act (CCPA), the California Online Privacy Protection Act (CalOPPA), the General Data Protection Regulation (GDPR), and other applicable International Data Protection Laws.<br /><br />
...
`,
    ...
    {
      title: "POLICY UPDATE",
      content: `We may amend or update our Privacy Policy. We will provide you notice of amendments to this Privacy Policy, as appropriate, and update the “Last Modified” date at the top of this Privacy Policy. Your continued use of our services confirms your acceptance of our Privacy Policy, as amended; you must stop using our services. Please review our Privacy Policy from time to time.`,
    },
    {
      title: "CONTACT US",
